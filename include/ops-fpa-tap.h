...
int ops_fpa_bridge_create(const char *name, const struct ether_addr *mac);
int ops_fpa_bridge_delete(const char *name);
int ops_fpa_bridge_port_add(const char *name);
int ops_fpa_bridge_port_rm(const char *name);
